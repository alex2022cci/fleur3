 ...
 */
final class Version20230227090139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pictures DROP name');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pictures ADD name VARCHAR(255) NOT NULL');
